...
sub load_table {
    ...
    local $config->{ hub    } = $self->workspace;
...
Cog::Database::Model - database model component

=head1 DESCRIPTION

This is a subclass of L<Badger::Database::Model> with some additional functionality
